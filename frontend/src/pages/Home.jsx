                        ...
                        <div>
                            <div className="lg:w-[570px]">
                                ...
                                <p className="text_para">
                                    Lorem ipsum dolor sit amet consectetur, adipsiting elit.
                                </p>
                ...
                <div className="container">
                    <div className="lg:w-[470px] mx-auto">
                        <h2 className="heading text-center">
                            ...
                            <p className="text_para text-center"> World class institution. Deserves a World Class care for everyone. Our Health System offers unmatched, expert healthcare.</p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-[30px] mt-[30px] lg:mt-[55px]">
                        ...
                        <div className="py-[30px] px-5">
                                ...
                                <p className="text-[16px] leading-7 text-textColor font-[400] mt-4 text-center">World class institution. Deserves a World Class care for everyone. Our Health System offers unmatched, expert healthcare.</p>
                    ...
                    <div className="flex item-center justify-between flex-col lg:flex-row">
                        ...
                        <div className="relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-0">
                            ...
                            <div className="w-[150px] lg:w-[248px] bg-white absolute bottom-[50px] left-0 md:bottom-[100px] md:left-5 z-20 p-2 pb-3 lg:pt-4 lg:px-4 lg:pb-[26px] rounded-[10px]">
                                ...
                                <div className="w-[65px] lg:w-[96px] bg-[#CCF0F3] py-1 px-2 lg:py-[6px] lg:px-[10px] text-[8px] leading-[8px] lg:text-[12px] lg:leading-4 text-irisBlueColor font-[500] mt-2 lg:mt-4 rouded-full">
                                    Consultation
                                </div>
