...
const DoctorCard = ({doctor}) => {
    ...
    return (
        <div className="p-3 lg:p-5">
            ...
            <h2 className="text-[18px] leading-[30px] lg:text-[26px] lg:leading-9 text-headingColor font-[700] mt-2 lg:mt-5">{name}</h2>
            ...
            <div className="mt-2 lg:mt-4 flex items-center justify-between">
                ...
                <div className="flex items-center gap-[6px]">
                    <span className="flex item-center gap-[6px] text-[14px] leading-6 lg:text-[16px] leading-7 font-semibold text-headingColor"><img src={starIcon} alt="" />{avgRating}</span>
                    <span className="flex item-center gap-[6px] text-[14px] leading-6 lg:text-[16px] leading-7 font-[400] text-textColor">({totalRating})</span>
                </div>
            </div>
